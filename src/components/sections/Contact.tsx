        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="contact__info">
            ...
            <div className="space-y-6">
              ...
              <a href={`https://wa.me/5571991895994?text=${encodeURIComponent('Olá! Vi o site da ENCODED e gostaria de iniciar um projeto. Estou vindo da seção de contato do site.')}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-white transition-colors group">
