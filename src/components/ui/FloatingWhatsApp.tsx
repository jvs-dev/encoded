 ...
 */
export function FloatingWhatsApp({ show, onTrackClick }: FloatingWhatsAppProps) {
  return (
    <AnimatePresence>
      {show && (
        <motion.a 
          ...
          href={`https://wa.me/5571991895994?text=${encodeURIComponent('Olá! Vi o site da INCODED e gostaria de tirar algumas dúvidas.')}`} 
          target="_blank" 
          ...
          onClick={() => onTrackClick('WhatsApp Flutuante')}
        >
