...
export default function Landing() {
  ...
  const portfolioSites = siteContent.portfolioSites || PORTFOLIO_SITES;
  const portfolioLogos = siteContent.portfolioLogos || PORTFOLIO_LOGOS;
  const portfolioPosts = siteContent.portfolioPosts || PORTFOLIO_POSTS;
  const sitePartners = siteContent.partners || PARTNERS;
  const siteFaqs = siteContent.faqs || FAQS;
  const siteTestimonials = siteContent.testimonials || TESTIMONIALS;
    ...
    <div className="landing min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black overflow-x-hidden">
      ...
      <main>
        ...
        <About 
          ...
          imageUrl={siteContent.aboutImage}
        />
        <Services 
          ...
          onTrackClick={trackClick} 
        />
        <ROISection subtitle={siteContent.roiSubtitle} />
        <Packages 
        ...
        {shouldShowPartners && <Partners partners={sitePartners} />}
        <Contact 
        ...
        />
        <FAQ subtitle={siteContent.faqSubtitle} faqs={siteFaqs} />
